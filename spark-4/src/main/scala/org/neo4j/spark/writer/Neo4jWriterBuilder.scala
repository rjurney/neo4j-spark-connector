...
class Neo4jWriterBuilder(
  ...
  override def build(): Write = new Write {
    ...
    override def toBatch: BatchWrite = buildBatchWriter()

    override def toStreaming: StreamingWrite = buildStreamingWriter()
  ...
  private def buildBatchWriter(): BatchWrite =
  ...
  private def buildStreamingWriter(): StreamingWrite = {
